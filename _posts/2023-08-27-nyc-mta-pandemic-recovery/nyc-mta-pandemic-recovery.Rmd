...
From the very start, bridge and tunnel traffic and Access-A-Ride ridership never collapsed to the same degree as the other transit modes. This is especially evident in Figure \@ref(fig:raw) where bus ridership actually fell below vehicle traffic passing through MTA bridges and tunnels. The recovery of bridge and tunnel traffic and Access-A-Ride ridership have also been the most robust, being the only two transit modes to have already reached pre-pandemic levels of usage. 
